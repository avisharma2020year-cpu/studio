...
export const mockUsers: User[] = [
  ...
  { id: 'faculty-bob', name: 'Bob The Builder', email: 'bob@example.com', role: 'faculty', subjects: ['Data Structures', 'Algorithms'] },
  ...
  { id: 'faculty-eve', name: 'Eve The Engineer', email: 'eve@example.com', role: 'faculty', subjects: ['Database Management', 'Operating Systems'] },
  
  // Faculty from the new approval list
  { id: 'faculty-ravi', name: 'Dr. Ravi Kiran', email: 'ravi.k@example.com', role: 'faculty' },
  { id: 'faculty-rajanikanth', name: 'Dr. M Rajanikanth', email: 'rajanikanth.m@example.com', role: 'faculty' },
  { id: 'faculty-disha', name: 'Dr. Disha Pathak', email: 'disha.p@example.com', role: 'faculty' },
  { id: 'faculty-syed', name: 'Syed Sir', email: 'syed@example.com', role: 'faculty' },
  { id: 'faculty-ishaq', name: 'Ishaq Sir', email: 'ishaq@example.com', role: 'faculty' },
  { id: 'faculty-meera', name: 'Meera Ma’am', email: 'meera@example.com', role: 'faculty' },
...
export const mockTimetable: TimetableEntry[] = [
    ...
    { id: 'tt3', day: 'Tuesday', timeSlot: '11:00 - 12:00', subjectName: 'Database Management', facultyName: 'Eve The Engineer', facultyId: 'faculty-eve', course: 'Computer Science', semester: 3 },
    ...
    { id: 'tt6', day: 'Friday', timeSlot: '10:00 - 11:00', subjectName: 'Operating Systems', facultyName: 'Eve The Engineer', facultyId: 'faculty-eve', course: 'Computer Science', semester: 3 },
];
...
export const getCurrentUser = (role: 'student' | 'faculty' | 'admin'): User => {
  ...
  // Set default faculty to Dr. Ravi Kiran for testing
  if (role === 'faculty') return mockUsers.find(u => u.id === 'faculty-ravi')!; 
